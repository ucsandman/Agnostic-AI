...
def _safe_fetch(url: str, max_minutes_to_wait: int = 5) -> dict[str, Any] | None:
...
if __name__ == "__main__":
    ...
    fetch_parser = subparsers.add_parser("fetch", help="Fetch data from InterPro API")
    ...
    count_parser.add_argument("--accession", help="Specific accession", default=None)
    count_parser.add_argument(
    ...
    count_parser.add_argument(
        "--query_params",
        nargs="*",
        help=("Query parameters as key=value pairs. All parameters must include '='."),
        default=None,
    )
    count_parser.add_argument(
        "--flags",
