...
class ComposerClient:
    ...
    def get_airflow_uri(self, project: str, location: str, environment: str) -> str:
...
def trigger_dag(project: str, location: str, environment: str, dag_id: str) -> str:
...
def main() -> None:
    ...
    parser.add_argument("--environment", required=True, help="Composer Environment")
