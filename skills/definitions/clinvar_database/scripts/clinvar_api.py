...
class ClinVarClient:
    ...
    def _extract_conditions(self, root: ET.Element) -> list[dict[str, str | None]]:
...
def main():
    ...
    parser = argparse.ArgumentParser(description="ClinVar Database API Wrapper Script")
    ...
    p_summary = subparsers.add_parser(
        "summary",
        help=("Get clinical significance, star rating, and phenotypes for variant IDs"),
    )
    ...
    p_summary.add_argument("--output", required=True, help="Output JSON file path")
    ...
    p_evidence.add_argument("--output", required=True, help="Output JSON file path")
