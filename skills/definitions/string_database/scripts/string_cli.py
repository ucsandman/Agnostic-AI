...
def main():
    ...
    parent_out.add_argument("--output", required=True, help="File to write output to")
    ...
    p_ft.add_argument("--term_text", required=True, help="e.g. Melanoma, GO:0008543")
    ...
    # version
    subparsers.add_parser("version", parents=[parent_out], help="Get STRING version")
    ...
    if args.command in requires_species and (
        ...
        print(f"Error: Command '{args.command}' requires --species", file=sys.stderr)
        sys.exit(1)
