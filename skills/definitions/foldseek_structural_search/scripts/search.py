...
def main():
    ...
    print("[*] Fetching results (this might take a moment for large databases)...\n")
    ...
    for hit in alignments_list:
        ...
        seq_id = str(hit.get("seqId", hit.get("seqIdentity", hit.get("fident", "N/A"))))
        aln_len = str(hit.get("alnLength", hit.get("alnLen", hit.get("alnlen", "N/A"))))
