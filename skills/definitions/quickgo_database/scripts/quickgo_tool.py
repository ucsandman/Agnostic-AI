...
def main():
    ...
    # ECO Subcommands
    eco_parser = subparsers.add_parser("eco", help="Evidence & Conclusion Ontology")
    ...
    ann_parser = subparsers.add_parser("annotation", help="Annotation search endpoints")
    ...
    gp_search_p.add_argument("--query", required=True, help="Query string (e.g. PROC)")
