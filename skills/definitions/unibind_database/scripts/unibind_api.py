...
def _add_pagination_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--order", help="Order by field (prefix with - for descending)")
...
def _add_dataset_filters(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--biological-condition", help="Biological condition or source")
...
def main() -> None:
    ...
    # list_datasets
    p_list_ds = subparsers.add_parser("list_datasets", help="List and filter datasets")
