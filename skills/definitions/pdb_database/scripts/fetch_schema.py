...
API_URLS = {
    ...
    "data_polymer_entity": ("https://data.rcsb.org/rest/v1/schema/polymer_entity"),
    ...
    "data_branched_entity": ("https://data.rcsb.org/rest/v1/schema/branched_entity"),
...
def main():
    ...
    print(f"Processed {len(sorted_lines)} properties. Output written to {args.output}")
