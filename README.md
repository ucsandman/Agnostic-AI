...
| Context | `context-graph`, `declick-nudge`, `opus-handoff-inject`, `codex-memory-inject` | Load the modules the prompt, file or command calls for, under a token budget, with the reason attached |
