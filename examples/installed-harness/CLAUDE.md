...
> **Harness Status:** `[AGNOSTIC-HARNESS v2.0.0: ACTIVE & GOVERNED]` · Source of truth: Agnostic AI Engine (core/templates/targets.json) · Governance: DashClaw Governed Autonomy / Local Fallback

Prepend the session badge to the first reply of every session: `🛡️ [Agnostic Harness v2.0.0 | DashClaw Governed]`. Hook probes, not the badge, establish whether the harness works.
