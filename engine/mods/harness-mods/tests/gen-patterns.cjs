...
// secret shapes, engine/hooks/lib/secret-patterns.cjs. A hooks module may import only its own
...
const src = require(path.join(__dirname, '..', '..', '..', 'hooks', 'lib', 'secret-patterns.cjs'));
const lines = [
  '// secret-patterns.mjs — GENERATED COPY of engine/hooks/lib/secret-patterns.cjs (a hooks module may',
