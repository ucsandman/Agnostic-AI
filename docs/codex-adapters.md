...
The Codex-only hook adapters that sit beside the shared guards. Guard behavior and overrides for the shared set: [guards.md](guards.md). How Codex loads them: [parity.md](parity.md).
