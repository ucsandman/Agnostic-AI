---
name: manifest-gate
description: "Record always, let policy decide whether to block: the declared-vs-actual manifest check at commit time"
context:
  triggers:
    keywords: ["manifest gate", "manifest", "declared vs actual", "gate-manifest"]
  requires: ["harness-guards"]
  priority: 30
---
# Manifest Gate — declared-vs-actual verification at commit time

Added 2026-08-11. Retired 2026-09-03; the script is kept in the claude-config history, not in this repository
